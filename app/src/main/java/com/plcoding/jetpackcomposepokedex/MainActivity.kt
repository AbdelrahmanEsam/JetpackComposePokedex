...
import com.plcoding.jetpackcomposepokedex.pokemondetails.PokemonDetailScreen
        ...
        setContent {
            ...
            val navController = rememberNavController()
                    ...
                    startDestination = "pokemon_list_screen" )
                {
                    ...
                    composable("pokemon_detail_screen/{dominantColor}/{pokemonName}",arguments = arrayListOf(
